...
typedef enum MAV_CMD
{
	...
	MAV_CMD_NAV_IDLE=94, /* Mission command to pause motors while landed on the ground |Delay in seconds (decimal)| motor sequence number (a number from 1 to max number of motors on the vehicle). 0 for all motors (!NOT IMPLEMENTED YET!)| Empty| Empty| Empty| Empty| Empty|  */
